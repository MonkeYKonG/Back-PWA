    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('style', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.musicstyle')),
            ],
        ),
        migrations.CreateModel(
            name='UserFollowing',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sound', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='api.sound')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_on', models.DateTimeField(auto_now=True)),
                ('message', models.TextField()),
                ('playlist', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='api.playlist')),
